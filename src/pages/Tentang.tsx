        ...
        <div className="flex">
            <div className="w-full mx-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-800">
                <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0 mx-4">
                    <figure className='flex flex-col items-center space-x-2 pt-10'>
                        <img className="w-[10rem] mb-3 rounded-full shadow-lg" src="https://avatars.githubusercontent.com/u/52753423?s=400&u=b326e86f7e27516928b7662ee3f05de529d34921&v=4" alt="Bonnie image" />
                        <figcaption className='mb-1 text-2xl font-medium text-gray-900 dark:text-white text-center'>Roynaldi</figcaption>
                        <figcaption className="text-sm text-center text-gray-500 dark:text-gray-400">Tech Enthusiast | Student</figcaption>
                        <figcaption className="text-sm text-center font-bold text-gray-500 dark:text-gray-400">STMIK Widya Utama Purwokerto</figcaption>
                    </figure>
