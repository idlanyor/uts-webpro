            ...
            <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-16">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
                        Crafted with skill and made with 🩷!
                    </p>
                </div>
                ...
                <div className="lg:grid flex flex-col items-center grid-cols-1 mt-12 text-center sm:mt-16 gap-x-16 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="space-y-4">
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="rounded-t-lg" src="/translate.png" alt="" />
                            </a>
                            <div className="p-5 space-y-4">
                                ...
                                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Translate across programming languages in just one click.</p>
                    ...
                    <div className="space-y-4">
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="rounded-t-lg" src="/roidev.png" alt="" />
                            </a>
                            <div className="p-5 space-y-4">
                                <a href="#">
                                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Personal Blog</h5>
                                </a>
                                <div className="space-x-2 space-y-1">
                                    <span className="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                        <span className="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                ...
                                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">My personal blog,build with Tailwindcss & Nextjs Server side rendering.</p>
                                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    More
                                </a>
                            </div>
                    ...
                    <div className="space-y-4">
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="rounded-t-lg" src="/ssg-portfolio.png" alt="" />
                            </a>
                            <div className="p-5 space-y-4">
                                <a href="#">
