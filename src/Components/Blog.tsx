        ...
        <section className="w-full mx-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-800">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                    ...
                    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">I use an agile approach to test assumptions and connect with the needs of your audience early and often.</p>
                </div>
                <div className="grid gap-8 lg:grid-cols-2">
                    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-4">
                                <img className="w-7 h-7 rounded-full" src="/ore.webp" alt="Roy avatar" />
                                <span className="font-medium dark:text-white">
                                    Roynaldi
                                </span>
                            </div>
                            <a href="https://woafoame.net/4/7623247" className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                Read more
                    ...
                    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Build Telegram bot webhook using NodeJs</a></h2>
                        <p className="mb-5 font-light text-gray-500 dark:text-gray-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, quo. Magnam minima aspernatur labore, in asperiores expedita odio cum itaque suscipit! Eveniet maxime labore temporibus soluta sequi itaque! Fugiat possimus blanditiis, cum eius soluta illo accusamus ea fuga dolor unde omnis adipisci rem, modi repellat officiis dolore dolorum perspiciatis qui.</p>
                        <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-4">
                                <img className="w-7 h-7 rounded-full" src="ore.webp" alt="Roy avatar" />
                                <span className="font-medium dark:text-white">
